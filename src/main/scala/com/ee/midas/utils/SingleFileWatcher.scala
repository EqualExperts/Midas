...
import org.apache.log4j.helpers.{LogLog, FileWatchdog}
import scala.concurrent.duration.TimeUnit

class SingleFileWatcher(fileName: String, watchEvery: Int, watchUnit: TimeUnit)(actionOnModify: () => Unit) extends FileWatchdog(fileName: String) {
